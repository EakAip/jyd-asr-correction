...
- **2026-08-14 · v1.0.5** 📝 明确 AI 摘要模型为智谱 GLM-4-Flash，补充流式输出与技术架构说明。
- **2026-08-14 · v1.0.4** 📋 完善更新日志，新增音频文件转写与 AI 智能摘要功能详细说明。
- **2026-08-14 · v1.0.3** 🔄 调整功能模块顺序，热词定制提前至意图识别之前；新增待办清单。
- **2026-08-13 · v1.0.2** 📚 新增完整项目文档，包含 API 文档、常见问题、贡献指南等章节。
- **2026-08-12 · v1.0.1** 🖼️ 整理项目截图至 docs/images/ 目录，补充热词、意图识别、API 文档示例图。
- **2026-08-10 · v1.0.0** 🎉 正式版发布，完成语音实时转写、自动纠错、意图识别、AI 摘要等核心功能。
- **2026-08-08 · v0.9.0** 🌓 新增深色/浅色模式自动切换，全局配色系统优化。
- **2026-08-05 · v0.8.0** 🎯 集成意图识别服务，支持 43+ 种语音指令意图实时识别。
- **2026-08-03 · v0.7.0** 🔤 完成热词表构建与配置功能，支持多模板管理与快速切换。
- **2026-08-01 · v0.6.0** ✨ 实现纠错特效，高亮显示纠错文字，动态徽章脉冲动画。
- **2026-07-30 · v0.5.0** 📁 新增音频文件转写功能，支持多格式音频上传与独立结果展示。
- **2026-07-28 · v0.1.0** 🚀 项目启动，完成基于 FunASR 的实时语音识别与 2pass 自动纠错。
...
- **智谱AI GLM-4-Flash**: 使用GLM-4系列快速模型
- **一键总结**: 点击"总结"按钮智能生成摘要
- **流式输出**: 实时显示生成过程
